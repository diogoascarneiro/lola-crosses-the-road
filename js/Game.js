class Game {
  ...
  level1() {
    ...
    this.obstacles.push(
      ...
      //Mid-Top
      new Person("male2", 40, currentGame.goal.y + 160 * 2.2, 0.7, 0.7, "down"),
      new Person(
        "male1",
        canvas.width - 40,
        currentGame.goal.y + 160 * 2.2,
        0.7,
        0.7,
        "down"
      ),
    ...
    this.obstacles.push(
      ...
      new DecorObst(
        "smallTree",
        currentGame.goal.x - 16,
        currentGame.goal.y + 32,
        2,
        2
      ),
      new DecorObst(
        "smallTree",
        currentGame.goal.x + 102,
        currentGame.goal.y + 4,
        2,
        2
      ),
    ...
    createRoad(this.goal.y + 160 * 2.6, 3);
    ...
    // Mid road
    createCar(125, this.goal.y + 160 * 2.6, 64, 32, "blue", "left");
    createCar(800, this.goal.y + 160 * 2.6, 48, 32, "green", "left");
    createCar(375, this.goal.y + 160 * 2.6, 64, 32, "red", "left");

    createCar(125, this.goal.y + 160 * 2.6 + 64, 64, 32, "blue", "right");
    createCar(800, this.goal.y + 160 * 2.6 + 64, 48, 32, "green", "right");
    createCar(375, this.goal.y + 160 * 2.6 + 64, 64, 32, "red", "right");
    ...
    for (let i = 0; i < 20; i++) {
      this.obstacles.push(
        new DecorObst("bush", 856 + i * 24, canvas.height - 128, 1.5, 1.5)
      );
    }
    ...
    this.obstacles.push(
      new DecorObst("statue", 750, canvas.height - 348, 3, 3)
    );
